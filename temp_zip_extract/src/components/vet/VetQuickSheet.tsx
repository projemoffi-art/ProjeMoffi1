                ...
                <>
                    ...
                    >
                        ...
                        <div className="px-8 pt-10 pb-6 flex items-center justify-between">
                            <div>
                                <h3 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase italic leading-none">Veteriner Hizmetleri</h3>
                        ...
                        <div className="px-8 pb-12 space-y-8 overflow-y-auto no-scrollbar">
                            ...
                            <section>
                                <div className="flex items-center justify-between mb-4 px-1">
                                    <h4 className="text-[10px] font-black text-zinc-400 dark:text-white/20 uppercase tracking-widest flex items-center gap-2">
                                ...
                                {isVetLoading ? (
                                    <div className="h-32 bg-zinc-100 dark:bg-white/5 animate-pulse rounded-[2rem]" />
                                ) : nearestClinic ? (
                                    <div 
                                        onClick={() => { router.push(`/vet?clinicId=${nearestClinic.id}`); onClose(); }}
                                        className="bg-zinc-50 dark:bg-gradient-to-br dark:from-white/[0.05] dark:to-transparent border border-zinc-200 dark:border-card-border rounded-[2.2rem] p-5 relative group overflow-hidden cursor-pointer active:scale-[0.98] hover:bg-zinc-100/50 dark:hover:bg-white/[0.08] transition-all"
                                    >
                                        <div className="flex items-start gap-4 relative z-10">
                                            <div className="w-16 h-16 rounded-2xl overflow-hidden border border-zinc-200 dark:border-card-border shrink-0">
                                                <img src={nearestClinic.imageUrl} className="w-full h-full object-cover" />
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <h5 className="font-black text-zinc-900 dark:text-white text-lg truncate mb-1">{nearestClinic.name}</h5>
                                                <div className="flex items-center gap-3">
                                                    <div className="flex items-center gap-1 text-xs text-zinc-500 dark:text-white/40 font-bold">
                                        ...
                                        <div className="flex gap-2 mt-5">
                                            <button 
                                                ...
                                                className="flex-1 bg-zinc-900 dark:bg-card text-white dark:text-black h-12 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-zinc-800 dark:hover:bg-white/90 active:scale-95 transition-all"
                                            >
                            ...
                            <section>
                                <h4 className="text-[10px] font-black text-zinc-400 dark:text-white/20 uppercase tracking-widest mb-4 px-1 flex items-center gap-2">
                                    <Syringe className="w-3 h-3" /> Sağlık Durumu
                                </h4>
                                
                                {isVaccineLoading ? (
                                    <div className="h-20 bg-zinc-100 dark:bg-white/5 animate-pulse rounded-2xl" />
                                ) : nextVaccine ? (
                                    <div className="bg-[#5B4D9D]/10 border border-[#5B4D9D]/20 rounded-[1.8rem] p-5 flex items-center justify-between group">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h6 className="text-zinc-900 dark:text-white font-black text-base italic uppercase">{nextVaccine.name}</h6>
                            ...
                            <section className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <span className="text-sm font-black text-zinc-900 dark:text-white uppercase italic leading-none">Klinik Ara</span>
                                </button>
                            </section>
                            ...
                            <button
                                ...
                                className="w-full bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-card-border py-5 rounded-[2rem] flex items-center justify-center gap-3 group hover:bg-zinc-900 dark:hover:bg-card hover:text-white dark:hover:text-black transition-all"
                            >
