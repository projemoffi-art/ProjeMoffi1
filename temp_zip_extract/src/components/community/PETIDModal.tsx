            ...
            >
                <div className="perspective-1000">
                    <motion.div
                        ...
                        className="w-full max-w-sm bg-[#0A0A0E] rounded-[3.5rem] p-8 border border-card-border shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden group"
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center relative z-10">
                            {/* OFFICIAL BADGE */}
                            <div className="flex items-center gap-2 mb-6 bg-white/5 px-4 py-2 rounded-full border border-card-border">
                            ...
                            <div className="mt-10 w-full space-y-4">
                                <div className="relative group/id overflow-hidden bg-white/5 border border-card-border rounded-[2rem] p-4 text-center transition-all hover:bg-white/10">
                                ...
                                <div className="flex gap-3">
                                    <button className="flex-1 h-14 bg-white/5 hover:bg-white/10 rounded-2xl flex items-center justify-center gap-2 text-white font-black text-[11px] uppercase tracking-widest transition-all active:scale-95 border border-card-border">
