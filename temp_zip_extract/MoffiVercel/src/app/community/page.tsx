...
const cleanDefaultTemplate = {
    ...
    dressing: {
        ...
        stylePoints: 0,
        avatarMock: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=200'
    },
    quests: [
...
export default function LegendaryLightDashboard() {
    ...
    const foodTarget = useMemo(() => {
        ...
        return typeof activePetObj.calories_target === 'number'
            ? activePetObj.calories_target
            : (activePetObj.sos_settings?.calories_target ?? 1600);
    }, [activePetObj.calories_target, activePetObj.sos_settings?.calories_target, activePetObj?.id]);
    ...
    const weeklyData = generateWeeklyData(resolvedStreak, resolvedActivityTarget);
                ...
                {hasNoPets ? (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <p className="text-xs font-semibold text-gray-455 mt-4 max-w-[280px] leading-relaxed">
