...
if (startIdx !== -1 && endIdx !== -1) {
    const bannerCode = `                {/* 8.5 Arcade / Game Center Premium Banner */}
                <section className="mb-10 px-5 relative z-20">
                    ...
                    >
                        {/* Subtle Glowing Background Elements - More Vibrant Now */}
                        <div className="absolute right-0 top-0 bottom-0 w-2/3 bg-gradient-to-l from-indigo-500/15 to-transparent pointer-events-none" />
                        <div className="absolute -right-10 -top-10 w-48 h-48 bg-purple-500/30 dark:bg-purple-500/40 rounded-full blur-3xl pointer-events-none group-hover:bg-purple-500/40 transition-colors" />
                        <div className="absolute -left-10 -bottom-10 w-40 h-40 bg-cyan-500/20 dark:bg-cyan-500/30 rounded-full blur-2xl pointer-events-none group-hover:bg-cyan-500/35 transition-colors" />
                        
                        <div className="relative z-10 flex flex-col justify-center h-full max-w-[65%]">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-8 h-8 rounded-[10px] overflow-hidden bg-indigo-500/20 flex items-center justify-center border border-white/20 shadow-md">
                                    <img src="/images/robot_moffi.jpg" alt="Robot Moffi" className="w-full h-full object-cover scale-110 mix-blend-luminosity hover:mix-blend-normal transition-all" />
                                </div>
                                <span className="text-[10px] font-black tracking-widest text-indigo-600 dark:text-indigo-400 uppercase drop-shadow-sm">
                                    Oyun Merkezi
                                </span>
                            </div>
                            <h3 className="text-[20px] md:text-[24px] font-black text-foreground tracking-tight leading-tight drop-shadow-sm">
                        ...
                        <div className="relative z-10 flex flex-col items-end justify-center shrink-0">
                            ...
                            <div className="flex items-center gap-1 text-[10.5px] font-bold text-gray-500 dark:text-gray-400 group-hover:text-indigo-500 transition-colors">
...
`;
    ...
    console.log('Banner updated with robot image.');
}
