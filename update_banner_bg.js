    ...
    const bannerCode = `                {/* 8.5 Arcade / Game Center Premium Banner */}
                <section className="mb-10 px-5 relative z-20">
                    ...
                    >
                        ...
                        {/* Giant Mascot in Background - Right Aligned, Faded Edges */}
                        <div className="absolute right-10 md:right-32 -top-[10%] -bottom-[10%] w-48 md:w-56 pointer-events-none z-0 mix-blend-screen opacity-90 filter brightness-110 contrast-125" style={{ maskImage: 'radial-gradient(ellipse at center, black 40%, transparent 70%)', WebkitMaskImage: 'radial-gradient(ellipse at center, black 40%, transparent 70%)' }}>
                            <img 
                        ...
                        <div className="relative z-10 flex flex-col items-end justify-center shrink-0">
                            ...
                            <div className="flex items-center gap-1 text-[10.5px] font-bold text-gray-500 dark:text-gray-400 group-hover:text-indigo-500 transition-colors bg-white/50 dark:bg-black/50 backdrop-blur-sm px-2 py-0.5 rounded-full">
...
`;
    ...
    console.log('Banner updated with giant background mascot.');
}
