                ...
                {activeSubView === 'main' ? (
                        ...
                        <div className="px-6 relative -mt-16 mb-6">
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex items-center gap-2 mt-2 sm:mt-0">
                                    ...
                                    {/* [V2_FEATURE] - Şimşek ikonu (Action Hub) gizlendi 
                                    <button onClick={() => {
                                        onOpenActionHub?.();
                    ...
                    <motion.div key="subview" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="px-4 pt-4 pb-32">
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-2xl font-black text-foreground italic tracking-tighter uppercase leading-none">
                                    {activeSubView === 'wallet' ? 'Cüzdan MerkeZİ' : 
                                     ...
                                     activeSubView === 'passport' ? 'Dijital Pasaport' :
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {activeSubView === 'passport' && activePet && (
                                <div className="pt-2">
                                    <PassportTab pet={activePet} onClose={() => onSubViewChange?.('dashboard')} />
                                </div>
                            )}
                            {activeSubView === 'passport' && !activePet && (
                                <div className="text-center py-20 opacity-40 font-black text-foreground uppercase italic tracking-[0.2em]">
                                    Pasaport bilgisi için bir pati seçin
                                </div>
                            )}
                        </AnimatePresence>
                    </motion.div>
...
function PetDashboardView({ pets, activePet, switchPet, onAddPet, posts, safeActivePetIndex, user, onSubViewChange }: any) {
    return (
