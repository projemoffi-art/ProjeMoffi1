            ...
            >
                <div className="perspective-1000">
                    <motion.div
                        ...
                        className="w-full max-w-sm bg-background dark:bg-[#0A0A0E] rounded-[3.5rem] p-8 border border-card-border shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden group"
                    ...
                    >
                        ...
                        <button onClick={onClose} className="absolute top-8 right-8 z-20 p-2 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:bg-white/10 transition-colors">
                            <X className="w-5 h-5 text-gray-500 dark:text-gray-400" />
                        </button>

                        <div className="flex flex-col items-center relative z-10">
                            {/* OFFICIAL BADGE */}
                            <div className="flex items-center gap-2 mb-6 bg-black/5 dark:bg-white/5 px-4 py-2 rounded-full border border-card-border">
                            ...
                            <div className="relative mb-6">
                                <div className="w-28 h-28 rounded-[2.5rem] overflow-hidden border-2 border-card-border shadow-2xl relative z-10">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">{pet.breed || 'Moffi Citizen'}</span>
                                <div className="w-1 h-1 bg-gray-600 rounded-full" />
                                <ShieldCheck className="w-3 h-3 text-emerald-500" />
                            </div>

                            {/* QR CODE SECTION (PREMIUM GLASS) */}
                            <div className="mt-10 relative p-8 bg-card rounded-[3rem] shadow-[0_20px_50px_rgba(255,255,255,0.15)] group/qr">
                            ...
                            <div className="mt-10 w-full space-y-4">
                                <div className="relative group/id overflow-hidden bg-black/5 dark:bg-white/5 border border-card-border rounded-[2rem] p-4 text-center transition-all hover:bg-black/10 dark:bg-white/10">
