                ...
                <div className="p-8 pb-4 bg-white/80 dark:bg-[#111111]/80 backdrop-blur-3xl z-30 sticky top-0 border-b border-zinc-200 dark:border-card-border">
                    <div className="flex justify-between items-center mb-8 mt-2 sm:mt-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase italic leading-none">Aşı Takvimi</h2>
                                <p className="text-[10px] text-zinc-400 dark:text-white/30 font-black uppercase tracking-[0.3em] mt-2">
                ...
                <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-zinc-50 dark:bg-black/20">
                    {isLoading && (
                        <div className="flex flex-col items-center justify-center h-64 gap-4">
                            ...
                            <span className="text-[10px] font-black text-zinc-400 dark:text-white/20 uppercase tracking-[0.4em]">Veriler Hazırlanıyor</span>
                        </div>
                    )}
                    ...
                    {!isLoading && ruleset && activeTab === 'calendar' && (
                        <div className="relative pl-8 space-y-10">
                            {/* Vertical Line */}
                            <div className="absolute left-[3px] top-4 bottom-4 w-[2px] bg-gradient-to-b from-blue-500 via-zinc-200 dark:via-white/10 to-transparent opacity-20" />
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    <h3 className="text-lg font-black text-zinc-900 dark:text-white tracking-tight uppercase italic mb-1">{item.definition.name}</h3>
                                                    <p className="text-[10px] font-black text-zinc-400 dark:text-white/30 uppercase tracking-widest">
                                            ...
                                            {!isCompleted && (
                                                <button
                                                    ...
                                                    className="w-full h-12 bg-zinc-900 dark:bg-card text-white dark:text-black text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl flex items-center justify-center gap-2 hover:bg-zinc-800 dark:hover:bg-white/90 active:scale-95 transition-all shadow-xl"
                                                >
                        ...
                        <div className="grid grid-cols-1 gap-5">
                            {ruleset.definitions.map(def => (
                                <motion.div
                                    ...
                                    className="bg-white dark:bg-[#1C1C1E] p-6 rounded-[2.5rem] border border-zinc-200 dark:border-card-border shadow-2xl flex items-center gap-5 cursor-pointer hover:bg-zinc-50 dark:hover:bg-[#252528] transition-all group active:scale-[0.98]"
                                >
                                    <div className={cn(
                ...
                <AnimatePresence>
                    {activeDefinition && (
                        <motion.div
                            ...
                            animate={{ x: 0 }}
                            exit={{ x: "100%" }}
                            className="absolute inset-0 z-40 bg-white dark:bg-[#111111] overflow-y-auto custom-scrollbar"
                        >
                            {/* Details Header */}
                            <div className="sticky top-0 bg-white/80 dark:bg-[#111111]/80 backdrop-blur-3xl p-6 border-b border-zinc-200 dark:border-card-border flex items-center justify-between z-50">
                                <button onClick={() => { setSelectedRichRecord(null); setSelectedDefId(null); }} className="w-11 h-11 flex items-center justify-center rounded-full bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-card-border text-zinc-400 dark:text-white/40 hover:text-zinc-950 dark:hover:text-white transition-all">
                                    <ChevronRight className="w-6 h-6 rotate-180" />
                                </button>
                                <h3 className="text-xs font-black text-zinc-400 dark:text-white/30 uppercase tracking-[0.4em]">AŞI DETAYLARI</h3>
                            ...
                            <div className="p-8 pb-32">
                                <div className="flex flex-col items-center text-center mb-12">
                                    ...
                                    <h1 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase italic leading-tight mb-3">{activeDefinition.name}</h1>
                                ...
                                <div className="space-y-8">
                                    <div className="bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-card-border p-8 rounded-[3rem] relative overflow-hidden">
                                         <div className="absolute inset-0 bg-gradient-to-br from-zinc-100/50 to-transparent dark:from-white/5 dark:to-transparent pointer-events-none" />
                                        <h4 className="text-[10px] font-black text-zinc-400 dark:text-white/30 uppercase tracking-[0.3em] mb-4 flex items-center gap-2 italic"> Tıbbi Açıklama</h4>
                                        <p className="text-sm font-bold text-zinc-700 dark:text-white/70 leading-relaxed uppercase tracking-tight">{activeDefinition.description}</p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="bg-emerald-500/5 border border-emerald-500/10 p-6 rounded-[2.5rem] flex flex-col items-center text-center">
                                            ...
                                            <div className="text-lg font-black text-zinc-900 dark:text-white italic">{activeDefinition.minAgeWeeks} HAFTA</div>
                                        </div>
                                    </div>
                                    ...
                                    <button 
                                        ...
                                        className="w-full mt-8 bg-zinc-900 dark:bg-card text-white dark:text-black py-5 rounded-[2.5rem] font-black text-xs uppercase tracking-[0.3em] shadow-2xl active:scale-95 transition-all"
                                    >
                                        BİLGİYİ KAPAT
                                    </button>
                                </div>
