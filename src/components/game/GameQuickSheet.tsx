                    ...
                    >
                        ...
                        <div className="px-4 sm:px-8 pb-8 sm:pb-12 space-y-6 sm:space-y-8 overflow-y-auto no-scrollbar">
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                <div className="bg-white/5 border border-card-border rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-5 flex flex-col items-center justify-center gap-2 group hover:bg-white/10 transition-all">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <span className="text-[8px] sm:text-[9px] font-black text-white/30 uppercase tracking-widest mt-1">Seviye</span>
                                    </div>
                                </div>
                                <div className="bg-white/5 border border-card-border rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-5 flex flex-col items-center justify-center gap-2 group hover:bg-white/10 transition-all">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <span className="text-[8px] sm:text-[9px] font-black text-white/30 uppercase tracking-widest mt-1">Mutluluk</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <section>
                                ...
                                <div className="bg-gradient-to-br from-[#1A1A1A] to-transparent border border-card-border rounded-[1.5rem] sm:rounded-[2.2rem] p-4 sm:p-5 flex items-center justify-between group cursor-pointer hover:bg-white/5 transition-all">
                                    <div className="flex items-center gap-3 sm:gap-4">
                                        <div className="w-10 h-10 sm:w-14 sm:h-14 bg-white/5 rounded-xl sm:rounded-2xl flex items-center justify-center border border-card-border relative overflow-hidden">
