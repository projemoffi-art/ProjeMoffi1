                    ...
                    >
                        ...
                        <div className="px-8 pb-12 space-y-8 overflow-y-auto no-scrollbar">
                            ...
                            <section className="bg-gradient-to-br from-indigo-500/20 to-blue-500/10 border border-indigo-500/20 rounded-[2.2rem] p-6 relative overflow-hidden group">
                                ...
                                <p className="text-[9px] text-black/40 dark:text-white/30 font-black uppercase tracking-widest mt-3 text-right">{completedCount}/{totalCount} Görev Tamamlandı</p>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between bg-black/5 dark:bg-white/5 p-4 rounded-2xl border border-card-border">
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-orange-500/20 flex items-center justify-center text-orange-400">
                                                <Flame className="w-4 h-4" />
                                            </div>
                                            <span className="text-xs font-bold text-black/80 dark:text-white/80">Mama Yakala</span>
                                        </div>
