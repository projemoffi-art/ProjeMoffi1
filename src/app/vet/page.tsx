...
export default function VetPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] pb-32 font-sans relative text-white selection:bg-cyan-500/30">
            ...
            {/* HEADER */}
            <header className="sticky top-0 z-50 bg-[#050505]/60 backdrop-blur-3xl border-b border-card-border pb-4 transition-all">
                <div className="px-6 pt-8 pb-2 flex flex-col gap-6">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                            <button 
                                ...
                                className="w-11 h-11 rounded-2xl bg-white/5 border border-card-border flex items-center justify-center hover:bg-white/10 hover:scale-105 active:scale-95 transition-all"
                            >
                    ...
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="w-full h-14 pl-12 pr-4 bg-white/5 rounded-2xl border border-card-border outline-none font-bold text-sm text-white placeholder:text-white/20 focus:border-cyan-400/50 focus:bg-white/[0.08] transition-all relative z-10 text-center"
                            value={searchQuery}
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    activeCategory === cat.id 
                                        ? "bg-card text-black border-white shadow-[0_0_20px_rgba(255,255,255,0.2)]" 
                                        : "bg-white/5 text-white/60 border-card-border hover:border-card-border"
                                )}
                            >
                                <span>{cat.icon}</span>
                                {cat.label}
            ...
            <main className="px-6 py-8 space-y-8 relative z-10">
                ...
                <section className="relative w-full h-56 rounded-[2.5rem] overflow-hidden border border-card-border shadow-2xl">
                    ...
                    <div className="absolute bottom-6 left-6 flex items-end justify-between right-6 pointer-events-none">
                        ...
                        <button 
                            ...
                            className="bg-card text-black px-6 py-2.5 rounded-full text-[10px] font-black pointer-events-auto hover:bg-cyan-400 hover:text-black transition-all shadow-xl uppercase tracking-widest"
                        >
                            Keşfet
                        </button>
                    </div>
                ...
                <section id="clinics-list">
                    <div className="flex items-center justify-between mb-8 px-1">
                        ...
                        <button className="bg-white/5 border border-card-border px-4 py-2 rounded-2xl text-[10px] font-black text-white/40 flex items-center gap-2 hover:bg-white/10 hover:text-white transition-all">
                        ...
                        {featuredClinics.map((clinic, index) => (
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    clinic.isPremium ? "border-cyan-500/30 shadow-[0_20px_40px_rgba(6,182,212,0.08)]" : "border-card-border shadow-2xl"
                                )}
                            >
                                ...
                                <div className="flex flex-col gap-5 relative z-10">
                                    ...
                                    <div className="relative h-52 rounded-[2rem] overflow-hidden border border-card-border cursor-pointer" onClick={() => setDetailClinicId(clinic.id)}>
                                        ...
                                        <div className="absolute top-4 left-4 flex gap-2">
                                            ...
                                            <div className="bg-black/40 backdrop-blur-md text-white text-[9px] font-black px-3.5 py-1.5 rounded-full border border-card-border whitespace-nowrap">
                                                {clinic.distance}
                                            </div>
                                        </div>
                                        ...
                                        <div className="absolute bottom-4 left-5 right-5 flex items-end justify-between">
                                            ...
                                            <div className="flex flex-col items-end gap-1">
                                                <div className="bg-card px-2.5 py-2 rounded-xl shadow-2xl text-black flex flex-col items-center min-w-[40px]">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex gap-1.5">
                                            {(clinic.features || []).slice(0, 2).map((f: string) => (
                                                <span key={f} className="text-[8px] font-black bg-white/5 text-white/40 px-2.5 py-1.5 rounded-lg border border-card-border uppercase tracking-tighter">{f}</span>
                                            ))}
                                        </div>
                                        <div className="flex items-center gap-2.5">
                                            <button 
                                                onClick={() => setDetailClinicId(clinic.id)}
                                                className="w-11 h-11 rounded-2xl bg-white/5 border border-card-border text-white/40 flex items-center justify-center hover:bg-white/10 transition-all shadow-xl active:scale-90"
                                            >
                                                <ChevronRight className="w-4 h-4 text-white" />
                                            </button>
                                            <button
                                                onClick={() => openAppointment(clinic)}
                                                className="bg-card text-black h-11 px-6 rounded-2xl font-black text-[11px] uppercase tracking-widest hover:bg-cyan-400 hover:text-black transition-all shadow-2xl active:scale-95 whitespace-nowrap"
                                            >
                                                Randevu Al
                                            </button>
                                        </div>
            ...
            <AnimatePresence>
                ...
                {activeModal === 'appointment' && selectedClinic && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[100] bg-black/80 flex items-end sm:items-center justify-center p-0 sm:p-4 backdrop-blur-xl">
                        <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} className="w-full max-w-md bg-[#1C1C1E] rounded-t-[3rem] sm:rounded-[3.5rem] p-7 shadow-[0_50px_100px_rgba(0,0,0,0.5)] overflow-hidden h-[85vh] flex flex-col border border-card-border text-white relative">
                            ...
                            <div className="flex justify-between items-center mb-8 mt-2 sm:mt-0">
                                ...
                                <button onClick={() => setActiveModal(null)} className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center border border-card-border hover:bg-white/10 transition-all"><X className="w-5 h-5" /></button>
                            </div>

                            <div className="flex items-center gap-5 mb-8 p-5 bg-white/5 rounded-[2.2rem] border border-card-border relative overflow-hidden group">
                                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent pointer-events-none" />
                                <img src={selectedClinic.imageUrl} className="w-20 h-20 rounded-2xl object-cover shrink-0 border border-card-border" />
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                selectedDate === day.key 
                                                    ? "bg-card text-black border-white shadow-2xl shadow-white/10" 
                                                    : "border-card-border bg-white/5 text-white/30 hover:bg-white/10 hover:border-card-border"
                                            )}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                selectedTime === time 
                                                    ...
                                                    : "border-card-border bg-white/5 text-white/40 hover:bg-white/10 hover:border-card-border"
                                            )}
                                        >
                                            {time}
                                        </button>
                            ...
                            <div className="mt-auto pt-6 border-t border-card-border">
                                ...
                                <button
                                    ...
                                    className="w-full bg-card text-black py-5 rounded-[2rem] font-black text-sm uppercase tracking-[0.2em] shadow-[0_30px_60px_rgba(255,255,255,0.1)] disabled:opacity-20 transition-all flex items-center justify-center gap-3 active:scale-95 group"
                                >
                ...
                {activeModal === 'sos' && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[200] bg-emergency flex flex-col items-center justify-center p-8 text-center text-white overflow-hidden">
                        ...
                        <motion.div 
                            ...
                            className="bg-card text-emergency p-12 rounded-[3.5rem] mb-10 shadow-moffi-card relative z-10"
                        >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="bg-black/20 backdrop-blur-3xl p-8 rounded-[3rem] mb-12 border border-card-border max-w-sm mx-auto shadow-2xl">
                            ...
                            <div className="flex flex-col gap-5 w-80 mx-auto">
                                <button className="bg-card text-emergency py-6 rounded-[2.5rem] font-black text-xl flex items-center justify-center gap-4 shadow-2xl active:scale-95 transition-all uppercase tracking-widest">
                                    <Phone className="w-8 h-8 fill-current" /> ŞİMDİ ARA
                                </button>
                                <button className="bg-black/40 text-white py-6 rounded-[2.5rem] font-black flex items-center justify-center gap-3 border border-card-border backdrop-blur-md hover:bg-black/60 transition-all uppercase text-sm tracking-widest">
                ...
                {activeModal === 'rating' && selectedClinic && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[150] bg-black/90 backdrop-blur-2xl flex items-center justify-center p-6">
                        <motion.div initial={{ scale: 0.9, y: 30 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 30 }} className="w-full max-w-sm bg-[#1C1C1E] rounded-[3.5rem] p-9 border border-card-border shadow-[0_50px_100px_rgba(0,0,0,0.6)] relative overflow-hidden">
                            <div className="absolute top-[-20%] left-[-10%] w-64 h-64 bg-yellow-500/5 blur-[80px] rounded-full" />
                            
                            <button onClick={() => setActiveModal(null)} className="absolute top-8 right-8 w-11 h-11 bg-white/5 rounded-full flex items-center justify-center border border-card-border hover:bg-white/10 transition-all text-white/40 hover:text-white z-20"><X className="w-5 h-5" /></button>
                            
                            <div className="flex flex-col items-center text-center relative z-10">
                                <div className="w-24 h-24 rounded-[2.5rem] bg-white/5 overflow-hidden mb-6 border border-card-border shadow-2xl group">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-white/5 border border-card-border rounded-[2rem] p-5 text-sm font-bold text-white placeholder:text-white/10 outline-none focus:border-yellow-500/50 transition-all resize-none h-32 mb-8 focus:bg-white/10 shadow-inner"
                                />
                                ...
                                <div className="w-full flex flex-col gap-4">
                                    <button
                                        ...
                                        className="w-full bg-card text-black py-5 rounded-[2rem] font-black text-sm uppercase tracking-[0.2em] shadow-[0_20px_40px_rgba(255,255,255,0.1)] disabled:opacity-10 transition-all active:scale-95"
                                    >
                                        GÖNDER VE KAPAT
                                    </button>
                ...
                {activeModal === 'success' && (
                    <motion.div initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -100, opacity: 0 }} className="fixed top-12 inset-x-0 flex justify-center z-[300] pointer-events-none">
                        <div className="bg-card text-black px-8 py-4 rounded-full shadow-2xl font-black flex items-center gap-3 border border-card-border">
                ...
                {isExplorerOpen && (
                    ...
                    >
                        ...
                        <div className="absolute top-8 left-8 right-8 z-[201] flex justify-between items-center pointer-events-none">
                            <h3 className="bg-black/50 backdrop-blur-xl px-6 py-4 rounded-3xl border border-card-border text-white font-black text-xl italic uppercase tracking-tighter pointer-events-auto">Klinik Keşfı</h3>
                            <button 
                                onClick={() => setIsExplorerOpen(false)}
                                className="w-14 h-14 bg-card text-black rounded-full flex items-center justify-center shadow-2xl pointer-events-auto hover:bg-emergency hover:text-white transition-all active:scale-90"
                            >
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                        ...
                        <div className="absolute bottom-12 inset-x-8 z-[201] pointer-events-none flex justify-center">
                            <div className="bg-black/80 backdrop-blur-2xl px-8 py-5 rounded-[2.5rem] border border-card-border text-white/60 text-[10px] font-black uppercase tracking-[0.4em] pointer-events-auto shadow-2xl">
