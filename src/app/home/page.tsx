...
import { 
    ...
    ShoppingBag, Scissors, CalendarDays, Sparkles, ChevronRight, Bone, 
    Users, Play, Navigation, Flame, Droplets, Activity, Compass, Radio, 
    Battery, Volume2, Wifi, Coins, QrCode, Star, Shirt, ArrowUpRight, 
    TrendingUp, CheckCircle2, ShoppingBag as CartIcon, X, Shield, TrendingDown, 
...
const DAILY_QUOTES = [
    ...
    "Bir can sahiplenmek, onun tüm dünyasını değiştirmektir.",
    "Can dostunuzla geçirdiğiniz her an, en değerli hatıradır. 🐶",
    "Bugün dostunuzla harika bir yürüyüşe çıkmaya ne dersiniz? 🦮",
    "Moffi ile can dostunuzun her ihtiyacı güvence altında!",
    "Görevleri tamamlayın, patinizle bağınızı güçlendirin! 🦴",
    "Kaybolan patilerin sesi olun, Radar'ı takipte kalın.",
    "Birlikte atılan her adım, sonsuz bir dostluğun mührüdür.",
    "Dünyanın en saf sevgisi, size sallanan o kuyruktadır.",
    "Küçük patiler, büyük mutluluklar getirir."
];
                ...
                <header className="flex justify-between items-center mb-6 relative z-20">
                        ...
                        >
                            ...
                            {!lostPetMode && (
                                <>
                                    ...
                                    <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full border-[1.5px] border-white/20" />
                                </>
                            )}
                        </motion.button>
                        </>
                    ...
                    <div className="flex items-center gap-2 relative z-20">
                        ...
                        <motion.button 
                            ...
                            className="w-8 h-8 rounded-full overflow-hidden shadow-sm cursor-pointer hover:scale-105 transition-transform ml-1"
                        >
                            <UserAvatar
