...
export default function FoodPage() {
    ...
    return (
        <div className="min-h-screen dark: pb-32 font-sans">
            ...
            {/* HEADER */}
            <header className="sticky top-0 z-40 bg-white/80 dark:bg-black/80 backdrop-blur-xl px-6 pt-6 pb-4 border-b border-card-border dark:border-card-border">
                <div className="flex justify-between items-center mb-4">
                    <button onClick={() => { if (typeof window !== 'undefined' && window.history.length > 2) { router.back(); } else { router.push('/home'); } }} className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/10 flex items-center justify-center hover:bg-gray-200"><ChevronLeft className="w-6 h-6" /></button>
                    <div className="text-center">
                        <h1 className="text-xl font-black text-foreground dark:text-white">Beslenme Koçu</h1>
