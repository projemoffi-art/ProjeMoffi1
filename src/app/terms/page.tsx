...
export default function TermsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0E] text-white p-8 md:p-20 font-sans selection:bg-cyan-500/30">
            {/* Ambient Background */}
            ...
            >
                ...
                <div className="mt-40 pt-20 border-t border-white/5 text-center">
                    <p className="text-[10px] text-gray-700 font-black uppercase tracking-[0.5em] mb-10">{t('company.name')} Ecosystem © 2024</p>
                </div>
            </motion.div>
        </div>
    );
