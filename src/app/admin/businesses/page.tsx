                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-black/50 border border-black/10 dark:border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500 w-64" 
                        />
                    </div>
                </div>
                ...
                <div className="w-full text-left border-collapse">
                    ...
                    {isLoading ? (
                        <div className="flex justify-center items-center py-10">
                            <Loader2 className="w-6 h-6 animate-spin text-black/50 dark:text-white/40" />
                        </div>
                    ) : filteredBusinesses.length === 0 ? (
                        <div className="text-center py-10 text-black/50 dark:text-white/40 text-sm">
                        ...
                        filteredBusinesses.map(biz => {
                            ...
                            return (
                                <div key={biz.id} className="grid grid-cols-4 items-center py-4 border-b border-black/5 dark:border-white/5 hover:bg-black/5 dark:bg-white/5 transition-colors group">
                                    <div className="col-span-2 flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 flex items-center justify-center">
                                            <Shield className="w-4 h-4 text-black/50 dark:text-white/40" />
                                        </div>
                                        <div>
                                            ...
                                            <div className="text-black/50 dark:text-white/40 text-xs">ID: #{biz.id.slice(0, 8)}</div>
                                        </div>
                                    </div>
                                    <div className="text-black/60 dark:text-white/60 text-sm capitalize">{type}</div>
                                    <div>
                                        <span className={cn(
