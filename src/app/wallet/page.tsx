...
export default function WalletPage() {
    ...
    return (
        <div className="min-h-screen bg-background dark:bg-[background] font-sans pb-24">
            ...
            {/* Header */}
            <header className="sticky top-0 z-30 bg-card/80 dark:bg-[background]/80 backdrop-blur-xl border-b border-card-border dark:border-card-border px-6 py-4 flex items-center justify-between">
                <button onClick={() => router.back()} className="w-10 h-10 rounded-full bg-gray-100 dark:bg-card/5 flex items-center justify-center text-foreground dark:text-white">
                    <ArrowLeft className="w-5 h-5" />
                </button>
                <h1 className="text-lg font-black text-foreground dark:text-white">Cüzdan</h1>
                <button className="w-10 h-10 rounded-full bg-gray-100 dark:bg-card/5 flex items-center justify-center text-foreground dark:text-white">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col justify-between h-full text-white dark:text-black">
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="px-2 py-0.5 bg-card/10 dark:bg-black/10 backdrop-blur rounded-full text-[8px] font-bold tracking-widest uppercase border border-card-border">
                                        Moffi Bank
                                    </div>
                                </div>
                                <div>
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col justify-between h-full text-white">
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="px-2 py-0.5 bg-black/10 backdrop-blur rounded-full text-[8px] font-bold tracking-widest uppercase border border-card-border">
                                        Moffi Rewards
                                    </div>
                                </div>
                                <div>
                ...
                {activeWallet === 'fiat' && (
                    <div className="space-y-6 animate-in slide-in-from-right duration-500">
                        ...
                        <div className="bg-card dark:bg-[card] rounded-[2rem] p-6 shadow-moffi-card border border-card-border dark:border-card-border">
                            <h2 className="text-lg font-black text-foreground dark:text-white mb-4">Aylık Harcama</h2>
                                    ...
                                    {Object.entries(BUDGET_STATUS.categories).map(([key, cat]) => (
                                        <div key={key}>
                                            <div className="flex justify-between text-xs font-bold mb-1">
                                                ...
                                                <span className={cn(cat.spent > cat.limit ? "text-red-500" : "text-foreground dark:text-white")}>
                    ...
                    <div className="space-y-6 animate-in slide-in-from-right duration-500">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-green-50 dark:bg-green-900/10 p-5 rounded-3xl border border-green-100 dark:border-green-900/20 shadow-sm relative overflow-hidden">
                                ...
                                <div className="text-3xl font-black text-foreground dark:text-white mb-1">{COIN_STATS.totalEarned}</div>
                            ...
                            <div className="bg-red-50 dark:bg-red-900/10 p-5 rounded-3xl border border-red-100 dark:border-red-900/20 shadow-sm relative overflow-hidden">
                                ...
                                <div className="text-3xl font-black text-foreground dark:text-white mb-1">{COIN_STATS.totalSpent}</div>
                        ...
                        <div className="bg-card dark:bg-[card] rounded-[2rem] p-6 shadow-moffi-card border border-card-border dark:border-card-border">
                            ...
                            <div className="relative border-l-2 border-card-border dark:border-card-border ml-3 space-y-8 pl-6 py-2">
                                {COIN_HISTORY.map((t) => (
